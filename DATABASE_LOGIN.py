...
db = mysql.connector.connect(host="localhost",user="root",passwd="shivam2002",database="project_dbms")
mycur = db.cursor()
...
def logged():
    ...
    Label(logg, text="You can acess this bank management system ".format(username_varify.get()), fg="green", font="bold").pack()
    Label(logg, text=" Now , You have to close all the windows ".format(username_varify.get()), fg="red", font="bold").pack()
    Label(logg, text=" Then , You can automatically directed to the Landing Page  ".format(username_varify.get()), fg="brown", font="bold").pack()
    Label(logg, text=" Hope,you don't have any inconvineance".format(username_varify.get()), fg="brown", font="bold").pack()
...
def main_screen():
    ...
    Label(root,text="Welcome to Group_C3",font="bold",bg="grey",fg="black",width=300).pack()
    ...
    Label(root,text="").pack()
    Label(root,text="").pack()
    Label(root,text="Developed By Group_TEC3").pack()
