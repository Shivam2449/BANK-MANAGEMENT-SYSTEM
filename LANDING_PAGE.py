...
import DELETE_ACOUNT as da
import SEARCH_ACCOUNT as sa
...
hed = Label(root, text = "RESERVE BANK OF INDIA.", bg = "#90ee90",fg="#000000",font="Times 50 underline bold")
#placing the widget on the screen
hed.pack(fill=X)

#Bank details Heading Configurations 
instruction = Label(root, text = "Bank Details:",bg = "#f4a460",fg="#000000",font="Times 25 bold" , anchor = NW, padx=15, pady=10)
#placing the widget on the screen
...
services = Label(root, text = "Services:",bg = "#f4a460",fg="#000000",font="Times 25 bold" , anchor = NW, padx=15, pady=10)
#placing the widget on the screen
